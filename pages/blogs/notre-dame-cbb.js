...
export default function NotreDamePreview() {
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <Head>
        <title>Why 2025-26 Can Be the Year for Notre Dame and Micah Shrewsberry</title>
      </Head>

      <h1 className="text-3xl font-bold mb-2">
        Why 2025-26 Can Be the Year for Notre Dame and Micah Shrewsberry
      </h1>
      <p className="text-sm text-gray-500 mb-6">Brian Papiernik • August 11, 2025</p>
      <h2 className="text-xl font-semibold mt-8 mb-2">Roster Snapshot</h2>
      <ul className="list-disc pl-6 space-y-1 mb-4">
        <li><span className="font-semibold">Key Losses:</span> Tae Davis, Matt Allocco, JR Konieczny, Julian Roper</li>
        <li><span className="font-semibold">Returning Starters:</span> Markus Burton, Braeden Shrewsberry, Kebba Njie</li>
        <li><span className="font-semibold">Returning Bench:</span> Cole Certa, Sir Mohammed, Logan Imes, Garrett Sundra</li>
        <li><span className="font-semibold">Transfers:</span> Carson Towt</li>
        <li><span className="font-semibold">HS Recruits:</span> Jalen Haralson, Ryder Frost, Brady Koehler, Tommy Ahneman</li>
      </ul>
